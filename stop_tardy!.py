...
student = {0:'선생님', 1:'...(이름)',}
fine = [10000,2500,2000,3000,2500,2000,3000,2500,2500,2000,1500,1000,2500,2000,2500,3000,3000,0,3000,3000,2500,2000,500,0,1000]# ... 벌금
...
stime = ftime.read()
ftime.close()
standard_time = dt.datetime.strptime(stime,'%Y-%m-%d %H:%M:%S') #이번주 월요일을 기준
